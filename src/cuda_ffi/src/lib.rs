...
pub use segment_detect::{
    SegmentCounts, SegmentDetector, SegmentResult, detect_segments_inplace,
    segment_detect_temp_sizes,
};
pub use segmented_reduce::{
    SegmentedReducer, segmented_reduce_sum_f32_inplace, segmented_reduce_sum_f32_temp_size,
    segmented_reduce_sum_f64_inplace, segmented_reduce_sum_f64_temp_size,
};
pub use voxel_hash::{
    VoxelHash, hash_table_build, hash_table_capacity, hash_table_count_entries, hash_table_init,
    hash_table_query, hash_table_size, max_neighbors as voxel_hash_max_neighbors,
};

// Batch persistent NDT kernel (parallel multi-scan alignment)
pub use batch_persistent_ndt::{
    BatchPersistentNdt, batch_ndt_blocks_per_slot, batch_ndt_reduce_buffer_size,
    batch_ndt_total_blocks, batch_persistent_ndt_init_barriers_async_raw,
    batch_persistent_ndt_init_barriers_raw, batch_persistent_ndt_launch_async_raw,
    batch_persistent_ndt_launch_raw, batch_persistent_ndt_launch_warp_optimized_raw,
    batch_persistent_ndt_stream_sync_raw, batch_persistent_ndt_sync_raw, batch_reduce_buffer_size,
    batch_shared_mem_size, batch_warp_shared_mem_size,
};
...
pub use graph_ndt::{
    ...
    num_blocks as graph_ndt_num_blocks,
};
